    ...
    <div className="w-full">
      <div className="w-screen h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 p-2">
          <h2 className={`${playfairDisplay.className} py-2 text-4xl underline underline-offset-8 tracking-widest`}>
            GitHub Finder App
          </h2>
        </div>
      </div>
        ...
        <div className="col-span-4">
          <div className="py-2 text-zinc-100 ">
            <p className="py-2 tracking-wider text-base leading-relaxed">
              I built this application in React JS and is hosted Vercel. This application is pulling GitHub profiles
              from the GitHub API and displaying different users. The useContext hook is also being implemented for
              ...
              perferendis iure numquam perspiciatis corporis quidem molestias nam libero? Id, adipisci laboriosam ea
              porro facilis alias rerum officiis ut. Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda
              enim sed numquam, odit placeat omnis? Quisquam impedit quam ut, cupiditate totam reiciendis a excepturi
              ducimus repudiandae itaque quidem dolores magnam.
            </p>
          </div>
        </div>
        {/* tech box */}
          ...
          <div className="p-2">
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="text-center mt-2 pt-2">
                <Link href="https://github.com/colincheungkm/GitHub-Finder" target="_blank" rel="noreferrer">
                  <button className="px-8 py-2 my-1 bg-zinc-200 rounded-lg">Code</button>
                </Link>
                <Link href="https://git-hub-finder-colincheungkm.vercel.app" target="_blank" rel="noreferrer">
